...
def main(data_dir):
    ...
    # Reshape and resize data for VGG16 input
    ...
    # Adjust input shape to include channels
    ...
    # Save the model
    model.save('parkisions_vgg16_classification_model.h5')
...
if __name__ == "__main__":
    main('D:\\Project_2024\\Parkinson_N\\Dataset')
